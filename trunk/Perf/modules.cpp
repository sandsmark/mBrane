//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/ //_/_/ //_/_/  modules.cpp //_/_/ //_/_/  Eric Nivel //_/_/  Center for Analysis and Design of Intelligent Agents //_/_/    Reykjavik University, Menntavegur 1, 101 Reykjavik, Iceland //_/_/    http://cadia.ru.is
...
/*
 * this is done because the definition of the modules
 * is subclassed from a template. which can only be in a header
 * 
 */
#include "Perf_modules.h"

LOAD_MODULE(ping)
LOAD_MODULE(pong)
LOAD_MODULE(RRMaster)
LOAD_MODULE(RRModule)
LOAD_MODULE(SizeTest)
LOAD_MODULE(Loom)
